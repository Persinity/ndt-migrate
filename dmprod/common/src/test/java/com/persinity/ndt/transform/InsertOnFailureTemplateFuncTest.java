 ...
 * @author Ivan Dachev
 */
public class InsertOnFailureTemplateFuncTest extends EasyMockSupport {
	...
	public void testApply() throws Exception {
		...
		final InsertOnFailureTemplateFunc f = new InsertOnFailureTemplateFunc(sqlI, cols,
				new UpdateParamDmlFunc(sqlU, cols, idCols));
