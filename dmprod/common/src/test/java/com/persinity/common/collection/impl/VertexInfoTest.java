...
public class VertexInfoTest {
	...
	public void testEqualsHashCode() {
		...
		v2Edges.add(e12);
		v2Edges.add(e21);
		final VertexInfo<Integer, ComparableDirectedEdge<Integer, Integer, Integer>> vi11 = new VertexInfo<>(v1, v1Edges);
		final VertexInfo<Integer, ComparableDirectedEdge<Integer, Integer, Integer>> vi12 = new VertexInfo<>(v1, v1Edges);
		final VertexInfo<Integer, ComparableDirectedEdge<Integer, Integer, Integer>> vi2 = new VertexInfo<>(v2, v2Edges);
