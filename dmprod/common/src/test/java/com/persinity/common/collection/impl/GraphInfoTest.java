...
public class GraphInfoTest {
	...
	public void testEdgeDropped() {
		...
		Integer actualMostProneToCut = GraphInfo.of(bag.graph).getTheMostProneToCutVert(
				Arrays.asList(bag.v1, bag.v2, bag.v3));
	...
	public void testEqualsHashCode() {
		GraphInfo<Integer, ComparableDirectedEdge<Integer, Integer, Integer>> actualGi = new GraphInfo<>(new HashMap<>(
				bag.graphInfoMap));
