...
public class GraphInfo<V, E extends ComparableDirectedEdge<V, Integer, V>> {
	...
	public static <V, E extends ComparableDirectedEdge<V, Integer, V>> GraphInfo<V, E> of(final DirectedGraph<V, E> sc) {
	...
	public List<V> getTheMostDegreeDebalancedVerts() {
		final Set<VertexInfo<V, E>> viSet = CollectionUtils.getFirstGroup(degreeBalancesChart,
				new Function<VertexInfo<V, E>, Integer>() {
					@Override
