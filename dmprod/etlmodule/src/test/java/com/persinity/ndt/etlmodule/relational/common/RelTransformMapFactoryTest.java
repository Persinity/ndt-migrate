...
public class RelTransformMapFactoryTest extends EasyMockSupport {
    ...
    public void testGetMigrateMapNoCoalesce() {
        ...
        final RelTransformMapFactory relTransformMap = new RelTransformMapFactory(schemas, migrateSqlStrategy,
                twoEntities,
                TEST_WINDOW_SIZE, TransformInfo.MIGRATE_DONT_COALESCE);
        final Map<String, TransformInfo> loadMap = relTransformMap.getMigrateMap();
    ...
    public void testGetMigrateNoCoalesceMap() {
        ...
        final String actualDml1 = ((ParamDmlLoadFunc) ((RelLoadFuncComposition) info1.getLoadFunc()).getFb())
                .getParamDmlFunc().getSql();
        assertThat(actualDml1.substring(0, actualDml1.indexOf(")") + 1),
                is("insert leadingCol1 into clog_leadingEntity1 ON FAILURE do(do nothing for failed CLOG insert)"));
        ...
        final String actualDml2 = ((ParamDmlLoadFunc) ((RelLoadFuncComposition) info2.getLoadFunc()).getFb())
                .getParamDmlFunc().getSql();
        assertThat(actualDml2.substring(0, actualDml2.indexOf(")") + 1),
                is("insert leadingCol2 into clog_leadingEntity2 ON FAILURE do(do nothing for failed CLOG insert)"));
    ...
    public void testGetMergeMap() {
        ...
        final String actualDml1 = ((ParamDmlLoadFunc) ((RelLoadFuncComposition) info1.getLoadFunc()).getFb())
                .getParamDmlFunc().getSql();
        assertThat(actualDml1.substring(0, actualDml1.indexOf(")") + 1),
                is("insert leadingCol1 into entity1 ON FAILURE update(update leadingCol1 into entity1)"));
        ...
        final String actualDml2 = ((ParamDmlLoadFunc) ((RelLoadFuncComposition) info2.getLoadFunc()).getFb())
                .getParamDmlFunc().getSql();
        assertThat(actualDml2.substring(0, actualDml2.indexOf(")") + 1),
                is("insert leadingCol2 into entity2 ON FAILURE update(update leadingCol2 into entity2)"));
    }
