...
public class TestDm {
    ...
    public void installAndEnableNDT() {
        ...
        srcClogAgent = dbAgentExecutor.clogAgentInstallMount(srcDrivenDbAgentFactory, srcNdtDb, false);
        agentUtils.verifyClogMounted(srcNdtDb);
        dstClogAgent = dbAgentExecutor.clogAgentInstallMount(srcDrivenDbAgentFactory, dstNdtDb, false);
