...
/**
 * Serial transform integration test.
 * <p/>
 ...
 * <p/>
 * Before use: Configure your own source and destination DBs in etl-it.properties
 * and run dst/src-admin.sql to create the test users.
 *
 * @author Doichin Yordanov
 */
public class SerialTransformIT extends BaseTransformIT {
    ...
    public void execute(final List<List<String>> srcPopulateSqlBatches,
        ...
        getTestTransform().rollTargetConsistentSerial();
        getTestTransform().verifyDestEntityDataAfterDm();
        getTestDm().executeClogGcSerial();
        ...
        getTestMigrate().verifyTrlogDataAfterMigrate();
        getTestTransform().transformSerial();
        getTestTransform().verifyDestEntityDataAfterDm();
        getTestDm().executeClogGcSerial();
        getTestTransform().verifyEmptyClogs();
