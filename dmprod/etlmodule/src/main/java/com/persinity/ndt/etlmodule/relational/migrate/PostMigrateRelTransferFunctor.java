 ...
 * @author Ivan Dachev
 */
public class PostMigrateRelTransferFunctor extends RelTransferFunctor {

    public PostMigrateRelTransferFunctor(final TransferWindow<RelDb, RelDb> tWindow,
    ...
    public Set<TransferFunc<RelDb, RelDb>> apply(final Void aVoid) {
        final TransferFunc<RelDb, RelDb> postMigrateRelTransferFunc = new PostMigrateRelTransferFunc(
