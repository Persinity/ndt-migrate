...
public class VertexInfo<V, E extends ComparableDirectedEdge<V, Integer, V>> {
    ...
    public boolean equals(final Object obj) {
        ...
        final boolean result =
                this.vertex().equals(that.vertex()) && this.degree() == that.degree() && this.weightBalance() == that
                        .weightBalance() && this.degreeBalance() == that.degreeBalance();
        return result;
    }
    ...
    public String toString() {
        if (toString == null) {
            toString = StringUtils
                    .format("{}(degree = {}, edgeDegreeBalance = {}, edgeWeightBalance = {})", vertex(), degree(),
                            degreeBalance(), weightBalance());
        }
        return toString;
    }
